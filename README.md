...
</a><a href="https://github.com/AIDoit-2026/AIGateway/stargazers">
  <img alt="GitHub Stars" src="https://img.shields.io/github/stars/AIDoit-2026/AIGateway?style=flat&logo=github&label=Stars">
</a><a href="https://atomgit.com/AIDoit-2026/AIGateway">
  <img alt="AtomGit Stars" src="https://atomgit.com/AIDoit-2026/AIGateway/star/badge.svg">
</a><a href="https://deepwiki.com/AIDoit-2026/AIGateway">
...
</a><a href="https://render.com/deploy?repo=https://github.com/AIDoit-2026/AIGateway">
...
<p align="center">
  <a href="https://github.com/AIDoit-2026/AIGateway/tree/main/docs"><strong>📚 在线文档</strong></a> ·
  <a href="https://github.com/AIDoit-2026/AIGateway/blob/main/docs/getting-started.md">快速上手</a> ·
  <a href="https://github.com/AIDoit-2026/AIGateway/blob/main/docs/deployment.md">部署指南</a> ·
  <a href="https://github.com/AIDoit-2026/AIGateway/blob/main/docs/configuration.md">配置说明</a> ·
  <a href="https://github.com/AIDoit-2026/AIGateway/blob/main/docs/client-integration.md">客户端接入</a> ·
  <a href="https://github.com/AIDoit-2026/AIGateway/blob/main/docs/faq.md">常见问题</a>
</p>
...
**AIGateway** 作为这些中转站之上的**元聚合层（Meta-Aggregation Layer）**，把多个站点统一到 **一个入口（可按项目配置多个下游 API Key）**——下游所有工具（Cursor、Claude Code、Codex、Open WebUI 等）即可无感接入全部模型。当前支持的上游范围已经不止传统聚合面板，还包括：
...
<div align="center">
  <img src="docs/screenshots/metapi-architecture.png" alt="AIGateway: Federated AI Model Aggregation Gateway Architecture" style="max-width: 100%; height: auto;" />
</div>
...
Docker Compose、桌面安装包、反向代理、升级与数据库选项等详见 [部署指南](https://github.com/AIDoit-2026/AIGateway/blob/main/docs/deployment.md)。

📖 **[环境变量与配置](https://github.com/AIDoit-2026/AIGateway/blob/main/docs/configuration.md)** · **[客户端接入指南](https://github.com/AIDoit-2026/AIGateway/blob/main/docs/client-integration.md)** · **[常见问题](https://github.com/AIDoit-2026/AIGateway/blob/main/docs/faq.md)**
...
| 项目                                            | 说明                                    |
| ----------------------------------------------- | --------------------------------------- |
| [New API](https://github.com/QuantumNous/new-api)  | 新一代大模型网关，AIGateway 的主要上游之一 |
...
| 项目                                                 | 说明                                                      |
| ---------------------------------------------------- | --------------------------------------------------------- |
| [All API Hub](https://github.com/qixing-jk/all-api-hub) | 浏览器扩展版 — 一站式管理中转站账号，AIGateway 最初灵感来源 |
...
AIGateway 完全自托管，所有数据（账号、令牌、路由、日志）均存储在你自己的部署环境中，不会向任何第三方发送数据。代理请求仅在你的服务器与上游站点之间直连传输。
...
- 🐛 报告 Bug — [提交 Issue](https://github.com/AIDoit-2026/AIGateway/issues)
- 💡 功能建议 — [发起讨论](https://github.com/AIDoit-2026/AIGateway/issues)
- 🔧 代码贡献 — [提交 Pull Request](https://github.com/AIDoit-2026/AIGateway/pulls)
...
感谢所有为 AIGateway 提交代码、反馈问题、提供思路和实测数据的朋友。这个项目的很多能力，都是在社区的真实使用和反复打磨中慢慢长出来的。

特别感谢所有贡献者：

<a href="https://github.com/AIDoit-2026/AIGateway/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=AIDoit-2026/AIGateway" alt="Contributors" />
</a>
...
**⭐ 如果 AIGateway 对你有帮助，给个 Star 就是最大的支持！**
