          ...
          <div className="login-brand-header">
            <div className="brand-mark-frame brand-mark-frame-hero">
              <div className="brand-mark-canvas">
                <img src="/logo.png" alt="AIGateway" className="login-brand-logo" />
              </div>
            </div>
            <div className="login-brand-summary">
              <div className="login-brand-name">AIGateway</div>
...
export const sidebarGroups = [
  {
    ...
    items: [
      ...
      { to: '/accounts', label: 'API Key 连接', icon: <svg className="sidebar-item-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" /></svg> },
    ...
    <>
      <header className="topbar">
        ...
        <div className="topbar-logo">
          <img src="/logo.png" alt="AIGateway" style={{ width: 28, height: 28, borderRadius: 6 }} />
          <span className="topbar-logo-text">AIGateway</span>
        </div>
        ...
        {isMobile ? (
          ...
          >
            <div className="mobile-drawer-header">
              <img src="/logo.png" alt="AIGateway" />
              <span>AIGateway</span>
            </div>
          ...
          <PageTransition>
            <Suspense fallback={<RouteLoadingFallback />}>
              <Routes>
                ...
                <Route path="/tokens" element={<Navigate to="/accounts?segment=apikey" replace />} />
                <Route path="/oauth" element={<Navigate to="/accounts?segment=apikey" replace />} />
                <Route path="/checkin" element={<Navigate to="/accounts?segment=apikey" replace />} />
